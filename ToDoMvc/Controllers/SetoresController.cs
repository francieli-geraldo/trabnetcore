...
namespace ToDoMvc.Controllers
{
    public class SetoresController : Controller
    {
        ...
        public SetoresController(IGenericRepository<Setor> repositorySetor)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Setor setor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name")] Setor setor)
        {
            if (id != setor.Id)
            {
                return NotFound();
