...
namespace ToDoMvc.Controllers
{
    ...
    {
        private readonly IGenericRepository<Loja> _repositoryLoja;

        public LojasController(IGenericRepository<Loja> repositoryLoja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Endereco,Telefone,Email,CNPJ")] Loja cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
