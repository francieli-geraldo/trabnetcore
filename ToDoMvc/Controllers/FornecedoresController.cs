...
namespace ToDoMvc.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public FornecedoresController(IGenericRepository<Fornecedor> repositoryFornecedor)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Telefone,CNPJ")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Telefone,CNPJ")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
