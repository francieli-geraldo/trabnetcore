...
namespace Web.UI.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(DataAccessLayer.IGenericRepository<Models.Cliente> repositoryCliente)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DataNascimento,Endereco,Telefone,Email,CPF")] Models.Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,DataNascimento,Endereco,Telefone,Email,CPF")] Models.Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
